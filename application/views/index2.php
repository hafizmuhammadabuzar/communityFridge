...
<head>
    ...
    <meta property="og:url" content="http://communityfridge.org"/>
...
<!--         <div class="topbar">-->
<!--             <div class="holder">-->
<!--                 <span class="text">Phone:&nbsp;+1 234-567-6789 &nbsp;&nbsp;&nbsp; Email:&nbsp;info@example.com</span>-->
<!--             </div>-->
<!--         </div>-->
                ...
                <form action="<?php echo base_url().'search'; ?>" method="post">
                    ...
                    <div class="input-wrap">
                        <select id="city" name="city" disabled="disabled">
                            <option selected="selected" value="">City / Area</option>
                        </select>
                    </div>
    ...
    <div id="main">
        ...
        <section id="quotes">
            <div class="holder">
                <h2 class="section-head">Quote about Share Fridge</h2>
                ...
                <ul>
                    <li>
                        ...
                        <a href="<?php echo base_url().'download/img1.jpg'; ?>" class="link-download" download>Download</a>
                    </li>
                    <li>
                        <img src="<?php echo base_url(); ?>assets/images/img2.jpg" alt="quote image">
                        <a href="<?php echo base_url().'download/img2.jpg'; ?>" class="link-download" download>Download</a>
                    </li>
                    <li>
                        <img src="<?php echo base_url(); ?>assets/images/img9.jpg" alt="quote image">
                        <a href="<?php echo base_url().'download/img9.jpg'; ?>" class="link-download" download>Download</a>
                    </li>
                    <li>
                        <img src="<?php echo base_url(); ?>assets/images/img1.jpg" alt="quote image">
                        <a href="<?php echo base_url().'download/img1.jpg'; ?>" class="link-download" download>Download</a>
...
<!--                        <a href="#">Read More ></a>-->
                    ...
                    <div class="box">
                        <h3>Recently Add Stuff</h3>
                        <ul>
                            <?php foreach($fridges as $fridge): ?>
                            <li>
                                <img src="<?php echo base_url(); ?>assets/images/img3.jpg" alt="img 1">
                                <div class="text-area">
                                    <span class="text">
                                        <?php
                                        $address = (strlen($fridge['address']) > 30) ? substr($fridge['address'], 20).'...' : $fridge['address'];
                                        echo $address; 
                                        ?>
                                    </span>
                                    <span class="text"><?php echo $fridge['country']; ?></span>
                                    <ul>
                                        <li><?php echo join(', ', array_map('ucfirst', explode(',', $fridge['services']))); ?></li>
                                    </ul>
                                </div>
                            </li>
                            <?php endforeach; ?>
